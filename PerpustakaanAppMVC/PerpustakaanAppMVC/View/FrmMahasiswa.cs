...
namespace PerpustakaanAppMVC.View
{
    ...
    {
        //deklarasi objeck collection untuk menampung data mahasiswa
        private List<Mahasiswa> listOfMahasiswa = new List<Mahasiswa>();

        //deklarasi objek controllellr
        ...
        private void btnCari_Click(object sender, EventArgs e)
        {
            ...
            //panggil method search dan ambil datanya dan taruh kedalam collection
